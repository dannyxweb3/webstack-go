...
func NewHTTPServer(
	...
	s.GET("/disclaimer", indexHandler.Disclaimer)
	s.GET("/categories.html", indexHandler.Categories)
	s.GET("/categories", indexHandler.Categories)
	s.GET("/news.html", indexHandler.News)
	s.GET("/news", indexHandler.News)
	s.GET("/community.html", indexHandler.Community)
	s.GET("/community", indexHandler.Community)
	s.GET("/ai-communities.html", indexHandler.Community)
	s.GET("/ai-communities", indexHandler.Community)
